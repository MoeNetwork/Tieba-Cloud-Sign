...
function loadhead() {
	...
	echo '<title>'.SYSTEM_NAME.'</title><meta name="generator" content="God.Kenvix\'s Blog (http://zhizhe8.net) and StusGame GROUP (http://www.stus8.com)" /></head><body>';
	...
	echo '<link rel="stylesheet" href="'.SYSTEM_URL.'css/my.css">';
	echo '<script type="text/javascript" src="'.SYSTEM_URL.'js/my.js"></script>';
	doAction('header');
