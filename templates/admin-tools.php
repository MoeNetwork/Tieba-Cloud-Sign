...
<br/><br/><input type="button" onclick="location = '<?php echo SYSTEM_URL ?>index.php?mod=admin:tools&setting=optim'" class="btn btn-primary" value="优化所有的数据表">&nbsp;&nbsp;&nbsp;&nbsp;可清除所有数据表的多余数据

<br/><br/><input type="button" onclick="location = '<?php echo SYSTEM_URL ?>index.php?mod=admin:tools&setting=fixdoing'" class="btn btn-primary" value="修复计划任务状态">&nbsp;&nbsp;&nbsp;&nbsp;可解决运行计划任务始终提示已经有一个计划任务正在运行中的问题

<br/><br/><input type="button" onclick="location = '<?php echo SYSTEM_URL ?>index.php?mod=admin:tools&setting=reftable" class="btn btn-primary" value="扫描空闲的签到表">&nbsp;&nbsp;&nbsp;&nbsp;扫描空闲的签到数据表，用户注册时系统会自动扫描
