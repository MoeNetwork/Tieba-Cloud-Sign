...
function alert(text,title)
{
    ...
    if (text != null) {
        document.getElementById('watext').innerHTML = text; } else {
        document.getElementById('watext').innerHTML = '未指定的异常'; }
        if (title != null) {
            document.getElementById('watitle').innerHTML = title;} else {
                document.getElementById('watitle').innerHTML = '提示信息'; }
            $("#wabutton").click();
}
